...
Dopo aver delegato un dominio ad Adobe per l’invio di e-mail (consulta [Impostazione del nome di dominio](/help/putting-it-in-practice/ac-domain-name-setup.md)), Adobe creerà e utilizzerà alcuni sottodomini per funzioni specifiche.
